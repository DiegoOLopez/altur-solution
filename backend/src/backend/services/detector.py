...
# Modelo entrenado
# ------------------------------------------------------------------
# Archivo joblib que concentra el modelo entrenado por el equipo
# (clasificador + pipeline de características acústicas y de
# comportamiento conversacional).
MODEL_PATH = Path(__file__).resolve().parent.parent / "ai_models" / "model.pkl"
